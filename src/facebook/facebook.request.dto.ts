...
import { GetAuthorizationURLOptions, HandleAuthorizationCallbackOptions } from './auth.service';
...
export const GetAuthorizationURLQuerySchema = Joi.object<GetAuthorizationURLOptions>({
    state: Joi.string(),
});
...
export const AuthorizationCallbackQuerySchema = Joi.object<HandleAuthorizationCallbackOptions>({

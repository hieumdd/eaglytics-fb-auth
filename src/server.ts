...
import { getAuthorizationURL, handleAuthorizationCallback } from './facebook/auth.service';
...
export const server = () => {
    ...
    app.get('/user', validator.query(GetUserQuerySchema), ({ query }: ValidatedRequest<GetUserRequest>, res, next) => {
        getUser(query)
